...
export class DateTimeModel implements NgbDateTimeStruct {
    ...
    public static fromLocalString(dateString: string, dateFormat: string = null): DateTimeModel {
        console.log('fromLocalString');

        let date;
        
        if (dateFormat && dateFormat != ''){
            const tmp =  moment(dateString, dateFormat.replace('dd','DD'));
            date = moment(dateString, dateFormat.replace('dd','DD')).toDate();
            console.log(dateString);
            console.log(dateFormat);
            console.log(moment(dateString, dateFormat.replace('dd','DD')));
            console.log(date);
        }
        else{
